...
public class AmortizationServiceImpl implements AmortizationService {
	...
	public boolean createPdf(List<Payment> payments, ServletContext context, HttpServletRequest request,
	    ...
	    Paragraph paragraph= new Paragraph("payments", mainFont);
	    ...
	    table.addCell(accumulatedInterest);
          ...
          for (Payment payment: payments){
	        ...
	        paymentNumberValue.setExtraParagraphSpace(5);
	 	    ...
	 	    PdfPCell balanceValue =new PdfPCell(new Paragraph(payment.getBalance()+"", tableBody));
	 	    ...
	 	    PdfPCell principalPaidValue =new PdfPCell(new Paragraph(payment.getPrincipalPaid()+"", tableBody));
		 	...
		 	PdfPCell interestPaidValue =new PdfPCell(new Paragraph(payment.getInterestPaid()+"", tableBody));
			...
			table.addCell(interestPaidValue);
			 ...
			 PdfPCell accumulatedInterestValue =new PdfPCell(new Paragraph(payment.getAccumulatedInterest()+"", tableBody));
